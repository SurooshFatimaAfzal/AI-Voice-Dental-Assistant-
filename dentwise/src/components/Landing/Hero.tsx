      ...
      <div className="relative z-10 w-full px-6">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* LEFT CONTENT */}
            <div className="space-y-8"> {/* space-y-10 -> space-y-8 */}
              <div className="space-y-6">
                ...
                {/* MAIN HEADING */}
                {/* Change 3: Fonts scale down kiye (5xl->4xl, 6xl->5xl, 7xl->6xl) */}
            ...
            <div className="relative lg:pl-8">
              ...
              <Image
                src={"/hero.png"}
                alt="DentWise AI"
                width={500} // Image size thora chota kiya fitment ke liye
                height={500}
