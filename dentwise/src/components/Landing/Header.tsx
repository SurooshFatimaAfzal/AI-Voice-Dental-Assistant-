...
function Header() {
  return (
  <nav className="fixed top-0 left-0 w-full z-50 px-6 py-2 border-b border-border/50 bg-background/80 backdrop-blur-md h-16">
    <div className="max-w-6x1 mx-auto flex justify-between item-center">
      ...
      <div className="hidden md:flex items-center gap-8">
        <a href="#" className="text-muted-forground hover:text-foreground">
          How it Works
        </a>
        <a href="#" className="text-muted-forground hover:text-foreground">
          Pricing
