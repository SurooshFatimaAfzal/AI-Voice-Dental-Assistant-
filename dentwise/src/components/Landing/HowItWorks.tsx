import { ArrowRightIcon, Section, Zap, ZapIcon } from 'lucide-react'
  ...
  return (
    <section className="relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-20">
        ...
        <h2 className="text-4x1 md:text-5x1 lg:text-6x1 font-bold mb-6 tracking-tight">
        ...
        <p className="text-xl text-muted-foreground max-w-3x1 mx-autoo leading-relaxed">
